        ...
        {state.items.length > 0 ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-border-light mb-4">
                ...
                <button
                  onClick={clearCart}
                  className="text-sm text-border-dark hover:text-red-500 transition-colors"
                >
                  Clear Cart
                </button>
              </div>
              ...
              <Link
                href="/products"
                className="inline-flex items-center gap-2 mt-6 text-sm text-border-dark hover:text-text-primary transition-colors"
              >
          ...
          <div className="text-center py-16">
            <div className="w-24 h-24 bg-surface rounded-full flex items-center justify-center mx-auto mb-6">
              <ShoppingBag className="w-12 h-12 text-border-dark" />
            </div>
