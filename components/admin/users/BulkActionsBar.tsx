...
//   return (
//     <>
//       <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-3 bg-charcoal text-white rounded-brand shadow-2xl px-5 py-3 animate-in slide-in-from-bottom-4 duration-300">
//         <span className="text-sm font-medium text-warm-gray-light">
//           {count} user{count !== 1 ? "s" : ""} selected
//         </span>

//         <div className="w-px h-5 bg-warm-gray-dark" />

//         <button
//           onClick={() => setConfirmAction("ban")}
//           className="text-sm font-medium text-amber-400 hover:text-amber-300 transition-colors px-2 py-1 rounded hover:bg-white/10"
//         >
//           Ban Selected
//         </button>
...
//           className="text-sm font-medium text-red-400 hover:text-red-300 transition-colors px-2 py-1 rounded hover:bg-white/10"
//         >
//           Delete Selected
//         </button>
...
//           className="text-sm text-warm-gray-light hover:text-white transition-colors px-2 py-1 rounded hover:bg-white/10"
//         >
//           Clear
//         </button>
//       </div>
    ...
    <>
      <div
        className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40
                   flex items-center gap-3 bg-charcoal text-ivory
                   rounded-brand shadow-2xl px-5 py-3
      ...
      >
        ...
        <button
          onClick={onClearSelection}
          className="text-sm text-warm-gray-dark hover:text-ivory
                     transition-colors px-2 py-1 rounded-lg hover:bg-white/10"
        >
          Clear
        </button>
