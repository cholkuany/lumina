...
export function SellerResponseForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="ml-14 mt-4 bg-surface rounded-brand p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <textarea
            ...
            maxLength={1000}
            className={cn(
              'w-full px-4 py-3 bg-white border rounded-brand text-sm text-text-primary',
              'placeholder:text-border-dark resize-none',
          ...
          <div className="flex items-center justify-between mt-2">
            <div>
              ...
              <p className="text-xs text-border-dark">{response.length}/1000</p>
            </div>
